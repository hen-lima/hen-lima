...
<details>
  ...
  <br><h6>The **Common Core** is the combination of all projects and tests we progress through before chosing a specialty. Its content is assembled into tiers and can be tracked by using the **Holy Graph**: a radial scheme starting 
